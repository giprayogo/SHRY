...
def main():
    ...
    r, u, s, stdout_lines = timed_process_run(
        supercell_args, desc="[time supercell]"
    )
    ...
    print("------------------------------------------------------")
    print(
        "T_supercell: real, user, sys, {:.2f}, {:.2f}, {:.2f}".format(r, u, s)
    )
